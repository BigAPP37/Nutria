...
def breakfast_oats(rng: random.Random) -> dict:
    ...
    return make_recipe(
        ...
        items=items,
        steps=[
            "Mezcla la avena con la base cremosa hasta que quede uniforme.",
            f"Añade {INGREDIENTS[fruit].name.lower()} troceada por encima.",
            "Termina con el topping crujiente y sirve al momento.",
        ],
...
def breakfast_toast(rng: random.Random) -> dict:
    ...
    return make_recipe(
        ...
        steps=[
            ...
            "Prepara la proteína principal y colócala sobre las tostadas.",
            f"Añade {INGREDIENTS[fresh].name.lower()} y aliña justo antes de servir.",
        ],
...
def breakfast_wrap(rng: random.Random) -> dict:
    ...
    return make_recipe(
        ...
        items=items,
        steps=[
            "Cocina el relleno principal en una sartén hasta que esté en su punto.",
            "Calienta la tortilla unos segundos para que sea flexible.",
            "Rellena, enrolla con firmeza y sirve caliente.",
        ],
...
def lunch_bowl(rng: random.Random, meal_type: str = "lunch") -> dict:
    ...
    return make_recipe(
        ...
        items=items,
        steps=[
            f"Cocina la base principal hasta que quede suelta y en su punto.",
            "Saltea o cocina la proteína con las verduras hasta que estén tiernas.",
            "Monta el bowl en capas y termina con el toque final justo antes de comer.",
        ],
...
def lunch_pasta(rng: random.Random, meal_type: str = "lunch") -> dict:
    ...
    return make_recipe(
        ...
        steps=[
            ...
            "Saltea la proteína con las verduras en una sartén amplia.",
            "Mezcla todo, ajusta el aliño y sirve caliente.",
        ],
...
def lunch_salad(rng: random.Random, meal_type: str = "lunch") -> dict:
    ...
    return make_recipe(
        ...
        items=items,
        steps=[
            "Prepara la base cocida y deja que pierda un poco de calor.",
            "Corta los vegetales y reparte todo en una fuente amplia.",
            "Añade la proteína, aliña al final y mezcla suavemente.",
        ],
...
def dinner_tray_bake(rng: random.Random) -> dict:
    ...
    return make_recipe(
        ...
        items=items,
        steps=[
            "Extiende la base y las verduras en una bandeja con aceite y condimentos.",
            "Hornea unos minutos hasta que empiecen a dorarse.",
            "Añade la proteína, termina la cocción y sirve recién hecho.",
        ],
...
def dinner_scramble(rng: random.Random) -> dict:
    ...
    return make_recipe(
        ...
        items=items,
        steps=[
            "Saltea las verduras hasta que pierdan rigidez.",
            "Añade el huevo batido y cocina removiendo con suavidad.",
            "Sirve con la guarnición elegida y consume al momento.",
        ],
...
def snack_yogurt(rng: random.Random) -> dict:
    ...
    return make_recipe(
        ...
        items=items,
        steps=[
            "Sirve la base cremosa en un vaso o cuenco.",
            "Añade la fruta troceada por encima.",
            "Termina con el topping crujiente justo antes de comer.",
        ],
...
def snack_hummus_plate(rng: random.Random) -> dict:
    ...
    return make_recipe(
        ...
        items=items,
        steps=[
            "Sirve el hummus en un plato o bol pequeño.",
            "Corta los vegetales en bastones cómodos para mojar.",
            "Añade el acompañamiento final y sirve al momento.",
        ],
