-- Corrige casteos explícitos a enums en el RPC de onboarding.
-- El frontend envía strings; Postgres no siempre castea TEXT -> enum
-- dentro de INSERT/UPDATE sobre columnas enum.
